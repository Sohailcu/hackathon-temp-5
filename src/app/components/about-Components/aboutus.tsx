...
const AboutUs = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between px-4 py-8 font-Montserrat ml-16">
      {/* Text Section */}
      <div className="w-full text-center md:text-left md:w-1/2 md:ml-16">
        ...
        <div className="mt-7 flex justify-center md:justify-start">
          <button className="px-6 py-3 bg-[#23A6F0] text-[#FAFAFA] rounded-btn hover:bg-blue-500 transition-all text-center text-[16px]">
            Get Quote Now
          </button>
        </div>
      </div>
